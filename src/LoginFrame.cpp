...
LoginFrame::LoginFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText3->SetFont( wxFont( 16, 74, 90, 92, false, wxT("Arial") ) );
	...
	m_staticText1->SetFont( wxFont( 9, 74, 90, 92, false, wxT("Arial") ) );
	...
	m_staticText2->SetFont( wxFont( 9, 74, 90, 92, false, wxT("Arial") ) );
